...
const ToDoList = () => {
  ...
  const addUser = (e) => {
    if (e.key === "Enter" && inputUser.trim() !== "") {
      postUser(inputUser).then((data) => {
        setUsers([...users, { name: data.name, id: data.id }]);
        setInputUser("");
      });
    }
  };
  ...
  return (
    <Container className="caja row font-monospace">
      <div className="col-6">
        <h2>Users List</h2>
        <input
          className="rounded border border-4 mb-2"
          type="text"
        ...
        <div>
          {users.map((person) => {
            return (
              <div
                className="usuario bg-danger-subtle border border-black rounded mb-1"
                key={person.id}
                onMouseEnter={() => setIsUserHovered(person.name)}
              ...
              >
                ...
                <span
                  ...
                  style={{
                    visibility:
                      isUserHovered === person.name ? "visible" : "hidden",
                  }}
              ...
              return (
                ...
                >
                  ...
                  <span
                    ...
                    style={{
                      visibility:
                        isTodoHovered === task.id ? "visible" : "hidden",
                    }}
